...
\bibitem{CathodeRays} J. J. ~Thomson, \textit{Cathode Rays}, Philosophical Magazine. C\textbf{44}, 293 (1897).
\bibitem{Wiki} J.J. ~Thomson, \textit{Rays of Positive Electricity}, Proceedings of the Royal Society. C\textbf{26}, 225 (1913).
\bibitem{Bainbridge} K. T. ~Bainbridge, \textit{The Specific Charge of the Electron}, American Journal of Physics. C\textbf{6}, 35 (1938).
\bibitem{Perrin} Britannica, \textit{Jean Perrin}, Encyclopedia Britannica. (2021).
\bibitem{Hertz} \textit{Mysterious Rays}, American Institute of Physics. (2022).
\end{thebibliography}
